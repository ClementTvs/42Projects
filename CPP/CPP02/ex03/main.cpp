...
int main( void ) {
	...
	assertFixedBool(true, bsp(pa, pb, pc, p), "Point in triangle");
	std::cout << "___________________________________________\n\n" << "\033[1;36m" << "Test 29:\n\n" << "\033[0m";
	Point pd(1.0f, 1.0f);
	Point pe(5.0f, 1.0f);
	Point pf(3.0f, 4.0f);
	...
	assertFixedBool(false, bsp(pd, pe, pf, pp), "Point not in triangle (On edge)");
	std::cout << "___________________________________________\n\n" << "\033[1;36m" << "Test 30:\n\n" << "\033[0m";
	Point pg(1.0f, 1.0f);
	Point ph(5.0f, 1.0f);
	Point pi(3.0f, 4.0f);
	...
	assertFixedBool(false, bsp(pg, ph, pi, ppp), "Point not in triangle");
	std::cout << "___________________________________________\n\n";
	return 0;
}